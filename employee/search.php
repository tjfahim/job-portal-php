            ...
            <div class="row">
                ...
                <div class="col-md-10 " style="margin-bottom: 59px;margin-top:20px">
                    ...
                    if(isset($_GET['query'])){
                        ...
                        $qu= "SELECT jobs.title,jobs.id,jobs.category,jobs.vacancy,jobs.location,jobs.salary,jobs.deadline,employer.companyname FROM jobs,employer WHERE (employer.id = jobs.username) AND (title like '%$query%' or category like '%$query%' or companyname like '%$query%') LIMIT 2 OFFSET $offset";
                        $quu= "SELECT jobs.title,jobs.id,jobs.category,jobs.vacancy,jobs.location,jobs.salary,jobs.deadline,employer.companyname FROM jobs,employer WHERE (employer.id = jobs.username) AND (title like '%$query%' or category like '%$query%' or companyname like '%$query%')";
